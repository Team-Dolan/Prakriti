/*!
  ...
  function openGoals(evt, typeGoal) {
    ...
    document.getElementsByClassName(typeGoal)[0].classList.add('show');
    //document.getElementsByClassName(typeGoal)[1].classList.add('show');
